      ...
      <div className="container xl:max-w-7xl mx-auto mt-20 md:mt-[144px]">
        ...
        <div className="flex gap-10 lg:gap-[110px] flex-col md:flex-row justify-between items-center">
          <div className=" flex flex-col gap-[24px] flex-1 order-2 md:order-1 text-[16px] leading-[24px] text-[#535353]">
            ...
            <p className=" ">
              Our team of experienced event planners, designers, and
              coordinators are dedicated to making your event a success. We
              offer a wide range of services, including venue selection, decor,
              catering, entertainment, and more. From concept to execution, we
